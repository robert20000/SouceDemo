...
WebUI.verifyElementText(findTestObject('Object Repository/Logout/Page_Swag Labs/div_Swag Labs'), 'Swag Labs')

WebUI.click(findTestObject('Object Repository/Logout/Page_Swag Labs/div_Accepted usernames arestandard_userlock_0ab16f'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Logout/Page_Swag Labs/span_Products'), 'Products')
